<template>
  <header class="sticky top-0 z-30">
    <nav
      class="bg-white border-gray-200 border-b dark:bg-[#0d1117] dark:border-gray-800"
    >
      <div
      ...
      >
        <div class="flex items-center">
          ...
          <a href="/" class="flex items-center">
            ...
            />
            <span
              class="self-center text-2xl font-semibold whitespace-nowrap dark:text-gray-400"
        ...
        <div class="flex items-center md:order-2">
          ...
          <button
            ...
            class="mr-2 hidden outline-none md:flex items-center text-sm leading-6 text-slate-400 rounded-md ring-1 ring-slate-900/10 shadow-sm py-1.5 pl-2 pr-3 hover:ring-slate-300 dark:bg-slate-800 dark:hover:bg-slate-700 dark:hover:ring-slate-700"
          >
            <svg
          ...
          <!-- 登录 -->
          <div
            class="text-gray-900 ml-1 mr-1 hover:text-blue-700 dark:text-white"
            v-if="!isLogined"
        ...
        >
          ...
          <button
            type="button"
            @click="clickSearchBtn"
            class="relative mt-3 flex w-full md:hidden items-center text-sm leading-6 text-slate-400 rounded-md ring-1 ring-slate-900/10 shadow-sm py-1.5 pl-2 pr-3 hover:ring-slate-300 dark:bg-slate-800 dark:highlight-white/5 dark:hover:bg-slate-700 dark:hover:ring-slate-700"
          >
            <svg
              class="w-3.5 h-3.5 mr-2 text-gray-500 dark:text-gray-400"
              aria-hidden="true"
          ...
          <ul
            class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-transparent md:dark:transparent"
          >
            <li>
              <a
                @click="router.push('/')"
                :class="[
                  currPath == '/'
                    ? 'text-sky-600 md:border-b-2 md:border-sky-600 dark:text-sky-500 dark:md:border-sky-600'
            ...
            <li>
              <a
                ...
                :class="[
                  currPath.startsWith('/category')
                    ? 'text-sky-600 md:border-b-2 md:border-sky-600 dark:text-sky-500 dark:md:border-sky-600'
                    : 'text-gray-900 dark:text-gray-400'
                ]"
                class="block py-2 pl-3 pr-4 rounded cursor-pointer md:rounded-none hover:bg-gray-100 md:hover:bg-transparent md:hover:text-sky-600 md:p-0 md:dark:hover:text-sky-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                >灵感</a
              >
            </li>
            <li>
  ...
  >
    <div class="relative p-4 w-full max-w-2xl max-h-full">
      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div v-if="searchArticles && searchArticles.length > 0">
            ...
            <ol class="mt-3 divide-y divider-gray-200 dark:divide-gray-600">
              <li v-for="(article, index) in searchArticles" :key="index">
                <a
                  ...
                  class="items-center cursor-pointer block p-3 sm:flex hover:bg-gray-100 hover:rounded-lg dark:hover:bg-gray-600"
                >
                  <img
            ...
            <div class="flex mt-7">
              <a
                v-if="current > 1"
                @click="prePage"
                class="flex items-center justify-center px-3 h-8 me-3 text-xs font-medium text-gray-500 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
              >
                <svg
              ...
              <a
                v-if="current < pages"
                @click="nextPage"
                class="flex ml-auto items-center justify-center px-3 h-8 text-xs font-medium text-gray-500 border border-gray-300 rounded-lg hover:bg-gray-100 hover:text-gray-700 dark:border-gray-600 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
              >
                <svg
                  class="w-3 h-3 rtl:rotate-180"
                  aria-hidden="true"
        ...
        <!-- Modal footer -->
        <div
          class="p-4 md:p-5 border-t text-xs flex items-center text-gray-400 dark:border-gray-600"
        >
          <!-- Esc 退出提示 -->
          <span
            class="px-2 py-[1px] flex-none border rounded dark:border-gray-600"
            >Esc</span
          >
        ...
        <div v-for="(catalog, index) in props.catalogs" :key="index">
          <h2 :id="'drawer-accordion-flush-heading-' + catalog.id">
            <button
              ...
              :data-accordion-target="
                '#drawer-accordion-flush-body-' + catalog.id
              "
              :aria-expanded="[
          ...
          >
            ...
            <li
              ...
              :key="index2"
              class="flex items-center ps-10 py-2 pe-3 rounded-lg cursor-pointer dark:text-gray-400"
              :class="[
