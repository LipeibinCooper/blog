  ...
  <FrontendLayout>
    ...
    <main class="container max-w-screen-xl mx-auto p-4">
      ...
      <div class="grid grid-cols-4 gap-7">
        <!-- 左边侧边栏，占用一列 -->
        <aside
          class="col-span-4 md:col-span-1 animate__animated animate__fadeInUp"
        >
                ...
                <div class="p-5">
                  ...
                  <div class="mb-3">
                    <span
                      ...
                      class="cursor-pointer bg-green-100 text-green-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded hover:bg-green-200 hover:text-green-900 dark:bg-green-900 dark:hover:bg-green-950 dark:text-green-300 whitespace-nowrap"
                    >
                      {{ tag.name }}
                    </span>
                  </div>
                  ...
                  >
                    <!-- 发布时间 -->
                    <svg
                      class="inline w-3 h-3 mr-2 text-gray-400"
                      aria-hidden="true"
                    ...
                    <!-- 所属灵感 -->
                    <svg
                      class="inline w-3 h-3 ml-5 mr-2 text-gray-400"
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 18 18"
