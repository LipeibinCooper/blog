...
public enum ResponseCodeEnum implements BaseExceptionInterface {
    ...
    CATEGORY_NAME_IS_EXISTED("20005", "该灵感已存在，请勿重复添加！"),
    TAG_CANT_DUPLICATE("20006", "请勿添加表中已存在的标签！"),
    TAG_NOT_EXISTED("20007", "该标签不存在！"),
    FILE_UPLOAD_FAILED("20008", "文件上传失败！"),
    CATEGORY_NOT_EXISTED("20009", "提交的灵感不存在！"),
    ARTICLE_NOT_FOUND("20010", "该文章不存在！"),
    CATEGORY_CAN_NOT_DELETE("20011", "该灵感下包含灵感笔记，请先删除对应灵感笔记，才能删除！"),
    TAG_CAN_NOT_DELETE("20012", "该标签下包含灵感笔记，请先删除对应灵感笔记，才能删除！"),
